...
module.exports = {
  ...
  /* Cards, in DOM order = z-order (1 backmost, 3 frontmost), matching the
     Figma layer stack inside 367:42780. Centres and rotations are exact. */
  cards: [
    {
  ...
  /* Floating marks. `size` is a percentage of board WIDTH; the CSS keeps them
     square via aspect-ratio, so one number does both axes.
     The cursor is decorative (empty label → alt="") — the four tool marks are
     real brands and are named. */
  icons: [
